...
import FactoryManagement.threads.ProductionLine_thread;
...
public class ProductLine {
    ...
    public void start() {
        setStatus(ProductLineStatus.RUNNING);
    }

    public void stop() {
        setStatus(ProductLineStatus.STOP);
    }
    ...
    public static ProductLine fromCSV(String csvLine) {
        ...
        return new ProductLine(Integer.parseInt(parts[0]), parts[1], ProductLineStatus.valueOf(parts[2]),
                Double.parseDouble(parts[3]), parts.length > 4 ? parts[4] : "");
    }
